...
public class SetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(sortbydestination!=null) {
			...
			request.setAttribute("bucketList", se/*pass the return value */);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
		...
		if(sortbyrank!=null) {
			...
			TreeSet<TouristPlace> sb= (TreeSet<TouristPlace>) sp.sortByRank(set);
			request.setAttribute("bucketList",sb /*pass the return value */);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
		...
		if(reset!=null) {
			...
			Set<TouristPlace> rs =(Set<TouristPlace>) sp.reset(set);
			request.setAttribute("bucketList",rs /*pass the return value */);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
